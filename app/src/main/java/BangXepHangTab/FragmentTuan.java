...
public class FragmentTuan extends Fragment {
    ...
    ListView lvListRankTuan;
    BackgroundTask backgroundTask;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_trongtuan,container,false);
        Anhxa();

        playerRecordAdapter = new PlayerRecordAdapter(view.getContext(),R.layout.line_rank,userArrayList);
        lvListRankTuan.setAdapter(playerRecordAdapter);
    ...
    public void onResume() {
        super.onResume();
        backgroundTask.loadListWeekUser(userArrayList,playerRecordAdapter);
    }

    private void Anhxa() {
        backgroundTask = new BackgroundTask(view.getContext());
        userArrayList = new ArrayList<>();
        lvListRankTuan = (ListView) view.findViewById(R.id.lvListRankTuan);
    }
}
